...
namespace QuickbooksWebService.DomainModel
{
    ...
    partial void InsertResponseXML(ResponseXML instance);
    partial void UpdateResponseXML(ResponseXML instance);
    partial void DeleteResponseXML(ResponseXML instance);
    ...
    partial void Deletewebpages_Role(webpages_Role instance);
		...
		public System.Data.Linq.Table<ResponseXML> ResponseXMLs
		{
			get
			{
				return this.GetTable<ResponseXML>();
			}
		}
	...
	public partial class Client : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<ResponseXML> _ResponseXMLs;
    ...
    partial void OnDiscountRefChanging(string value);
    partial void OnDiscountRefChanged();
    #endregion
		...
		public Client()
		{
			...
			this._ResponseXMLs = new EntitySet<ResponseXML>(new Action<ResponseXML>(this.attach_ResponseXMLs), new Action<ResponseXML>(this.detach_ResponseXMLs));
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_DiscountRef", DbType="NVarChar(50)")]
		public string DiscountRef
		{
			get
			{
				return this._DiscountRef;
			}
			set
			{
				if ((this._DiscountRef != value))
				{
					this.OnDiscountRefChanging(value);
					this.SendPropertyChanging();
					this._DiscountRef = value;
					this.SendPropertyChanged("DiscountRef");
					this.OnDiscountRefChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Client_Order", Storage="_Orders", ThisKey="ContentEditsClientID", OtherKey="ClientID")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Client_ResponseXML", Storage="_ResponseXMLs", ThisKey="ContentEditsClientID", OtherKey="ClientID")]
		public EntitySet<ResponseXML> ResponseXMLs
		{
			get
			{
				return this._ResponseXMLs;
			}
			set
			{
				this._ResponseXMLs.Assign(value);
			}
		}
		...
		private void attach_ResponseXMLs(ResponseXML entity)
		{
			this.SendPropertyChanging();
			entity.Client = this;
		}
		
		private void detach_ResponseXMLs(ResponseXML entity)
		{
			this.SendPropertyChanging();
			entity.Client = null;
		}
    ...
    partial void OnDiscountDescriptionChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_RequestXML", DbType="Text", UpdateCheck=UpdateCheck.Never)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Client_Order", Storage="_Client", ThisKey="ClientID", OtherKey="ContentEditsClientID", IsForeignKey=true)]
		public Client Client
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.ResponseXML")]
	public partial class ResponseXML : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnHresultChanging(string value);
    ...
    partial void OnClientIDChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Guid", DbType="NVarChar(80) NOT NULL", CanBeNull=false)]
		public string Guid
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Hresult", DbType="Text", UpdateCheck=UpdateCheck.Never)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Client_ResponseXML", Storage="_Client", ThisKey="ClientID", OtherKey="ContentEditsClientID", IsForeignKey=true)]
		public Client Client
		{
			get
			{
			...
			set
			{
							...
							|| (this._Client.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Client.Entity = null;
						previousValue.ResponseXMLs.Remove(this);
					}
					this._Client.Entity = value;
					if ((value != null))
					{
						value.ResponseXMLs.Add(this);
						this._ClientID = value.ContentEditsClientID;
					}
					else
					{
