...
with QuickBooks Point of Sale via QBWebConnector. The sample focuses primarily on 
...
configuration file (HTTPPOSWebService.qwc) for your convenience.  You could 
...
Building the sample
------------------
Open QWCPOSWebService.sln in Microsoft Visual Studio .NET and build the 
solution. 
